...
def run_experiment_cov_split_1(datafile):
    ...
    error_test, y_test_probs = Gx.test_results(covs_1_features, target, optimal)
    
    print("Testing Model on unseen Data")
    print("(Covs_1_Split Experiment Test Error (log-loss))")
    print(error_test)
    print()
